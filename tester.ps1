...
$vmware_list="SCM/srv-scm","Production/srv-monitoring","Production/srv-redmine","Production/srv-intranet","Build/srv-build-linux","Build/srv-cit","Network/srv-mail","Other/srv-tomcat"
